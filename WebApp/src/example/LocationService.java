 ...
 * 
 */
@WebServiceClient(name = "LocationService", targetNamespace = "http://example/", wsdlLocation = "http://localhost:8002/Location?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOCATIONSERVICE_QNAME = new QName("http://example/", "LocationService");
    ...
    public Location getLocationPort() {
        return super.getPort(new QName("http://example/", "LocationPort"), Location.class);
    }
     ...
     */
    @WebEndpoint(name = "LocationPort")
    public Location getLocationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example/", "LocationPort"), Location.class, features);
    }
